    ...
    static getHomeHtml(homeHtml , students) {
        ...
        students.map(async (student, index) => {
            tbody +=`
                    ...
                    <td><a href="/student/edit/${student.id}"><button class="">Edit</button></a></td>
                    <td>
                        <button class="" data-bs-toggle="modal" data-bs-target="#deleteModal${student.id}">Delete</button>
